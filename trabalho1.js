function main() {
  ...
  scene.add(line);
    ...
    // nao esta certo ainda, o movimento de aceleracao tem que ser gradual
    // um carrinho de kart nao tem RE, esse nosso por enquanto tem
    function keyboardUpdate() {
        ...
        if (keyboard.pressed("left") && anguloX > -0.4067366430758069) {
        ...
        if (keyboard.pressed("right") && anguloX < 0.24192189559966865) {
    ...
    function createPlane(width, height) {
        ...
        planeGeometry.translate(0.0, 0.0, -0.01); // To avoid conflict with the axeshelper
        var planeMaterial = new THREE.MeshBasicMaterial({
    ...
    // funcao que cria os dois eixos da roda
    function eixo() {
        var cylinderGeometry3 = new THREE.CylinderGeometry(0.07, 0.07, 3, 10);
        var cylinderMaterial3 = new THREE.MeshPhongMaterial({ color: 'rgb(255,255,0)' });
        var eixo = new THREE.Mesh(cylinderGeometry3, cylinderMaterial3);
        return eixo;
    }
